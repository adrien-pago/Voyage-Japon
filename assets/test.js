...
function displayCityGallery(city) {
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12" id="main-photo-section">
                <div id="photo-gallery">
                    <a id="gallery-photo-link" data-fancybox="gallery" href="">
    ...
    function updateGallery() {
        ...
        const galleryPhotoLink = document.getElementById('gallery-photo-link');
        galleryPhoto.src = photo.image;
        galleryPhotoLink.href = photo.image;
    ...
    function initFancybox() {
        Fancybox.show(
            cityPhotos.map((photo, index) => ({
                src: photo.image,
                thumb: photo.image, // Utilisation de la même image pour les vignettes
                caption: photo.description,
                type: "image"
            })),
            {
                thumbs: {
                    autoStart: true, // Affiche automatiquement les miniatures
                },
                dragToClose: false, // Empêche la fermeture par glissement, préférant le swipe
                Carousel: {
                    infinite: true, // Navigation infinie entre les images
                },
                Toolbar: {
                    display: [
                        { id: "counter", position: "center" }, // Affichage du compteur d'images
                        "close",
                    ],
                },
            }
    ...
    document.getElementById('next-photo').addEventListener('click', () => {
        ...
        updateGallery();
        initFancybox(); // Réinitialise Fancybox après le changement de photo
    });
...
function getCityPhotos(city) {
    const photoData = {
        ...
        'Kyoto': [
            ...
            // Ajoute les autres photos de Kyoto ici
        ],
